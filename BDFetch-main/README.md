...
<img width="2440" height="1600" alt="BDFetch_All" src="https://github.com/user-attachments/assets/1991aad3-64cc-4266-ac67-dab70c891ce7" />

## Requirements

Python 3.14 is recommended. Other Python versions may require different pip commands.
...
|
├── BDFetch.py                          # Main antivirus application entry point
├── BDFetch_Engine.py                   # Core scanning engine algorithm
├── BDFetch_Version.py                  # Version metadata for packaging and updates
└── ...
```

## Architecture diagram

BDFetch Security antivirus software general architecture diagram.
...
graph TD
    ...
    subgraph UserMode ["User Mode (Python / Web)"]
        ...
        BDFetchCore["BDFetch Core (BDFetch.py)"]:::userMode
        
        subgraph Engines ["Scanning Engines (BDFetch_Engine.py)"]
    ...
    subgraph KernelMode ["Kernel Mode (C++ Minifilter Driver)"]
        CommServer["ALPC Port (\\BDFetch_Output_Pipe)"]:::interaction
    ...
    CloudAPI["BDFetch Cloud Server"]:::storage

    %% User Mode Internal
    UI <-->|JS Evaluate / JSON| BDFetchCore
    BDFetchCore -->|Extract Features & Scan| Engines
    CloudScanner -.->|HTTPS REST API| CloudAPI
    BDFetchCore <-->|FilterSendMessage / FilterGetMessage| CommClient

    %% User-Kernel Boundary
    CommClient <-->|BDFetch_MESSAGE / BDFetch_USER_MESSAGE| CommServer
...
Source Available : https://bdfetch.66ghz.com/sd/

Official Website : https://bdfetch.66ghz.com/sd/

Online Analyze : https://bdfetch.66ghz.com/sd/

Packaged Download: https://github.com/87owo/BDFetch/releases

## Project License

For any questions, needs, or bug feedback, please contact us through the following website.

Source Issues : https://github.com/87owo/BDFetch/issues

Official Email : bdfetch@qq.com
